...
isi_kuota =[[0,'happy',3,'30hari',20000],
            [1,'sweet',5,'30hari',50000],
            [2,'corn', 10,'7hari', 15000],
            [3,'fine',2,'2hari', 5000],
            [4,'cool', 10,'30hari',50000]]

list_harian =[[0,'seharibisa',5,'1hari',5000],
              [1,'duaharicukup',2,'2hari',5000],
              [2,'murahmeriah', 10,'7hari', 15000],
              [3,'harianmeriah',5,'3hari', 15000],
              [4,'habisinaja', 10,'2hari',20000]]  

list_bulanan =[[0,'bulananoke',25,'30hari',50000],
               [1,'gassebulan',50,'30hari',75000],
               [2,'murahbulan', 10,'30hari',25000],
               [3,'2bulancukup',80,'60hari',150000],
               [4,'happyhemat',100,'90hari',180000]]
...
def create(asli):
    ...
    if baru1==1:
        ...
        if kode1 in range(len((asli))):
            ...
            jumlah = int(input('masukan jumlah/gb: '))
...
def create1(asli):
    ...
    if baru1==1:
        ...
        if kode1 in range(len((asli))):
            ...
            jumlah = input('masukan jumlah pulsa: ')
            harga = int(input('harga: ')) 
            tambah.append(kode1)  
            tambah.append(jumlah)
            tambah.append(harga)
            ...
            print('apakah data sudah sesuai?')
            print()
            print(f'data ==>{kode1}/{jumlah}/{harga}')
            print()
            keluar()
            kode2=int(input('masukan pilihan: '))
            if kode2 == 1: 
    ...
    if baru1==1:
        ...
        if baru2 not in range(len((asli))):
            ...
            def baru():
                table = tabulate(
                hasil, 
                headers=["kode", "nama (1)", "jumlah (2)",'berlaku (3)','harga (4)'], 
                tablefmt="grid")
                print(table)   
            hasil=[(asli)[baru2]]
            baru()
    ...
    try:
        while True:
            ...
            if ckode1 ==1:
                ...
                if cart1==1:
                    ...
                    while cart1==1:
                        ...
                        if bayar1==total_harga:
                            ...
                            keranjang2=keranjang.copy()
                            total.extend(keranjang2)
                            keranjang.clear()
                            break
                        else:
                            print('================ gagal ================')
                ...
                total2=0
                total_harga=0
                for kode,nama,jumlah,berlaku,harga in total:
                        total2=jumlah+total2
                print()
                print(f'==>kuota anda saat ini {total2}/gb')
